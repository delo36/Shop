class AddNewDeliveryAddressResponse {
  AddNewDeliveryAddressResponse({
      this.shippingName, 
      this.latitude, 
      this.longitude, 
      this.contactPhoneNo, 
  ...
  AddNewDeliveryAddressResponse.fromJson(dynamic json) {
  ...
  Addresses? addresses;
AddNewDeliveryAddressResponse copyWith({  String? shippingName,
  num? latitude,
  num? longitude,
  String? contactPhoneNo,
  Addresses? addresses,
}) => AddNewDeliveryAddressResponse(  shippingName: shippingName ?? this.shippingName,
