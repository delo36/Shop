class RegisterCustomerResponse {
  ...
  RegisterCustomerResponse.fromJson(dynamic json) {
    status = json['status'];
    data = json['data'] != null ? CustomerInfo.fromJson(json['data']) : null;
  }
  String? status;
  CustomerInfo? data;
RegisterCustomerResponse copyWith({  String? status,
  CustomerInfo? data,
}) => RegisterCustomerResponse(  status: status ?? this.status,
  data: data ?? this.data,
);
...
class CustomerInfo {
  ...
  Customer? customer;
  String? accessToken;
CustomerInfo copyWith({  Customer? customer,
  String? accessToken,
}) => CustomerInfo(  customer: customer ?? this.customer,
