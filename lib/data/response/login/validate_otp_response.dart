class ValidateOtpResponse {
  ...
  ValidateOtpResponse.fromJson(dynamic json) {
    status = json['status'];
    data = json['data'] != null ? ValidateOtpData.fromJson(json['data']) : null;
  }
  String? status;
  ValidateOtpData? data;
  ValidateOtpResponse copyWith({  String? status,
    ValidateOtpData? data,
  }) => ValidateOtpResponse(  status: status ?? this.status,
    data: data ?? this.data,
  );
...
class ValidateOtpData {
  ...
  ValidateOtpData copyWith({  Customer? customer,
    String? accessToken,
    String? registerVerifyToken
  }) => ValidateOtpData(  customer: customer ?? this.customer,
      accessToken: accessToken ?? this.accessToken,
      registerVerifyToken: registerVerifyToken ?? this.registerVerifyToken
  );
  Map<String, dynamic> toJson() {
    final map = <String, dynamic>{};
    if (customer != null) {
...
class Customer {
  ...
  Customer copyWith({  String? customerNo,
    String? customerName,
    String? phoneNumber,
    String? websiteUrl,
    String? marketName,
    ...
    List<CustomerPhotos>? customerPhotos,
    List<Contacts>? contacts,
  }) => Customer(  customerNo: customerNo ?? this.customerNo,
